...
Shader "Babybus/Unlit/Rim Color Texture An" {
Properties {
	...
	Pass {  
		CGPROGRAM
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed3 Rim = pow((1-i.NdotV) ,_RimPower) *_RimIntensity*_RimColor.a;	
				col.rgb = lerp(col.rgb,_RimColor.rgb,Rim.r);
				//col.rgb = saturate(col.rgb-Rim);
