...
Shader "Babybus/Particles/Dissolve Blend3" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            struct VertexOutput {
				...
				float custom : TEXCOORD2;
            };
            VertexOutput vert (VertexInput v) {
                VertexOutput o = (VertexOutput)0;
                o.uv0.xy = TRANSFORM_TEX(v.texcoord0.xy, _MainTex);
				o.uv0.zw = TRANSFORM_TEX(v.texcoord0.xy, _T_mask);
                o.vertexColor = v.vertexColor;
				o.custom = v.texcoord0.z;
